...
| :--- | :---: | :--- |
| [**VB.WorkstationReport**](https://www.powershellgallery.com/packages/VB.WorkstationReport) | ![PSGallery](https://img.shields.io/powershellgallery/v/VB.WorkstationReport?style=flat&color=5391FE) | End-to-end workstation auditing — profiles, printers, OneDrive, Sync Center, folder redirections, and Nextcloud upload |
| [**VB.NextCloud**](https://www.powershellgallery.com/packages/VB.NextCloud) | ![PSGallery](https://img.shields.io/powershellgallery/v/VB.NextCloud?style=flat&color=5391FE) | WebDAV utilities for Nextcloud — single-file PUT, batch upload with auto folder creation, PROPFIND directory listing |
| [**VB.ServerInventory**](https://www.powershellgallery.com/packages/VB.ServerInventory) | ![PSGallery](https://img.shields.io/powershellgallery/v/VB.ServerInventory?style=flat&color=5391FE) | 34 cmdlets across 10 categories for Windows Server auditing — AD, GPO, security, DHCP/DNS, RDS, shares, and more |
